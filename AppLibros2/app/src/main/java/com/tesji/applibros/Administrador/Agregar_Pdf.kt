...
import com.tesji.applibros.databinding.ActivityAgregarPdfBinding
...
class Agregar_Pdf : AppCompatActivity() {
    ...
    private fun SubirPdfStore(){
        ...
        storageReference.putFile(pdfUri!!)
            ...
            .addOnFailureListener { e ->
                ...
                Toast.makeText(this, "Falló la subida de archivo debido a ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }

    private fun SubirPdfBD(urlPdfSubiendo: String, tiempo: Long){
    ...
    //Permite ingresar al almacenamiento de nuestro dispositivo
