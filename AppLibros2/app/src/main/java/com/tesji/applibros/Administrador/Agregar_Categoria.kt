...
import com.tesji.applibros.databinding.ActivityAgregarCategoriaBinding
    ...
    private fun AgregarCategoriaBD(){
        ...
        ref.child("$tiempo")
            ...
            .addOnFailureListener { e->
                progressDialog.dismiss()
                Toast.makeText(applicationContext, "No se agregó la categoria dabido a ${e.message}", Toast.LENGTH_SHORT).show()
            }
